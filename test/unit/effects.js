...
test( "interrupt toggle", function() {
	...
	jQuery.expandedEach( { slideToggle: "height", fadeToggle: "opacity", toggle: "width" }, function( method, prop ) {
...
jQuery.expandedEach = jQuery.each;
jQuery.expandedEach([ "toggle", "slideToggle", "fadeToggle" ], function ( i, method ) {
